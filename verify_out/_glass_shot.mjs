...
// Expanded sidebar — full app + sidebar crop.
await page.screenshot({ path: 'verify_out/glass_full.png' });
await page.screenshot({ path: 'verify_out/glass_sidebar.png', clip: { x: 0, y: 0, width: 270, height: 900 } });

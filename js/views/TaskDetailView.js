...
App.TaskDetailView = class TaskDetailView {
    ...
    this.pane.innerHTML = `
      ...
      <div class="detail-body">
        ...
        <div class="detail-row">
          ...
          <input type="date" value="${t.due}" data-field="due" style="font-size:12px; padding:4px 8px;" />
        </div>
        <div class="detail-row">
  ...
  bindHandlers(t) {
    ...
    this.pane.querySelectorAll('[data-field]').forEach(el => {
      el.addEventListener('change', () => this.controller.updateTaskField(t.id, el.dataset.field, el.value));
    });

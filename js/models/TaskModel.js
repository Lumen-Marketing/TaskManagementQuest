...
App.TaskModel = class TaskModel {
  ...
  seedDefaults() {
    ...
    this.tasks = [
      { id:'t1',  title:'Lien filing — CNL job', type:'admin', company:'roofing', creator:'abraham', assignee:'abraham', watchers:['kristine'], due:iso(-4), priority:'high',   urgency:'urgent',   status:'todo',    description:'Mechanic\'s lien paperwork prepped. Need to file with Maricopa County recorder before end of week.', subtasks:[{t:'Pull deed info',d:true},{t:'Notarize',d:false}], activity:[{who:'Abraham',what:'created this task',when:'5d ago'}] },
      { id:'t2',  title:'Update QR ROC complaint draft', type:'admin', company:'roofing', creator:'abraham', assignee:'kristine', watchers:[], due:iso(-2), priority:'medium', urgency:'high', status:'pending', description:'Add the contract excerpt and email chain as exhibits before sending.', subtasks:[], activity:[{who:'Abraham',what:'assigned this to Kristine',when:'3d ago'}] },
      { id:'t3',  title:'CNL demand letter follow-up', type:'ar', company:'roofing', creator:'abraham', assignee:'abraham', watchers:['kristine'], due:iso(0), priority:'high', urgency:'critical', status:'todo', description:'Call CNL accounting by EOD. If no commitment, file mechanic\'s lien tomorrow + Justice Court small claims by Friday.', subtasks:[{t:'Send certified letter',d:true},{t:'Call accounting',d:false},{t:'Prep lien paperwork',d:false}], activity:[{who:'Kristine',what:'uploaded letter.pdf',when:'2h ago'},{who:'Abraham',what:'set due date today',when:'yesterday'}] },
      { id:'t4',  title:'Paradise Valley demo punch list', type:'bid', bidStatus:'started', company:'roofing', creator:'abraham', assignee:'alkeith', watchers:['abraham'], due:iso(0), priority:'high', urgency:'urgent', status:'todo', description:'Final walkthrough items. See photos in shared album.', subtasks:[{t:'Tear-off west slope',d:true},{t:'Replace decking 2 sheets',d:true},{t:'Drip edge install',d:false},{t:'Final cleanup + photos',d:false}], activity:[{who:'Abraham',what:'assigned this to Alkeith',when:'yesterday'}] },
      { id:'t5',  title:'Jesus week-2 KPI review', type:'meeting', company:'roofing', creator:'abraham', assignee:'abraham', watchers:['jesus'], due:iso(0), priority:'medium', urgency:'high', status:'review', description:'Review against 90-day vesting milestones. Doors knocked, appts set, contracts signed.', subtasks:[], activity:[] },
      { id:'t6',  title:'Send Andres weekly QA brief', type:'admin', company:'drafting', creator:'abraham', assignee:'abraham', watchers:[], due:iso(0), priority:'low', urgency:'medium', status:'todo', description:'', subtasks:[], activity:[] },
      { id:'t7',  title:'Adrian — confirm trial milestones', type:'meeting', company:'lumen', creator:'abraham', assignee:'abraham', watchers:['adrian'], due:iso(0), priority:'medium', urgency:'high', status:'todo', description:'3-month trial KPIs need to be in writing before next sync.', subtasks:[], activity:[] },
      { id:'t8',  title:'Lumen pitch deck v3 sign-off', type:'lead', company:'lumen', creator:'abraham', assignee:'adrian', watchers:['abraham'], due:iso(1), priority:'medium', urgency:'medium', status:'review', description:'Final review of HVAC pitch deck before client outreach.', subtasks:[], activity:[{who:'Abraham',what:'assigned this to Adrian',when:'2d ago'}] },
      { id:'t9',  title:'DraftTrack markup tool QA', type:'admin', company:'drafting', creator:'abraham', assignee:'andres', watchers:[], due:iso(1), priority:'medium', urgency:'medium', status:'todo', description:'Test all markup tools on Safari + Chrome. Document any issues.', subtasks:[], activity:[{who:'Abraham',what:'assigned this to Andres',when:'2d ago'}] },
      { id:'t10', title:'Schedule monsoon ad shoot', type:'admin', company:'lumen', creator:'abraham', assignee:'adrian', watchers:[], due:iso(3), priority:'medium', urgency:'medium', status:'todo', description:'Friday morning, blue sky. Confirm location + crew.', subtasks:[], activity:[] },
      { id:'t11', title:'Supabase auth wiring', type:'admin', company:'drafting', creator:'abraham', assignee:'abraham', watchers:[], due:iso(4), priority:'high', urgency:'high', status:'hold', description:'DraftTrack client portal — add auth + persistent storage.', subtasks:[], activity:[] },
      { id:'t12', title:'GC outreach v2 script', type:'lead', company:'roofing', creator:'abraham', assignee:'jesus', watchers:['abraham'], due:iso(5), priority:'medium', urgency:'medium', status:'todo', description:'Hormozi-style warm follow-up. Lead with the ROC + insurance angle.', subtasks:[], activity:[{who:'Abraham',what:'assigned this to Jesus',when:'today'}] },
      { id:'t13', title:'Order shingles, Gilbert job', type:'admin', company:'roofing', creator:'abraham', assignee:'kristine', watchers:[], due:iso(-1), priority:'medium', urgency:'medium', status:'done', description:'', subtasks:[], activity:[] },
      { id:'t14', title:'Send Adrian operating agreement', type:'admin', company:'lumen', creator:'abraham', assignee:'abraham', watchers:['adrian'], due:iso(-2), priority:'high', urgency:'high', status:'done', description:'', subtasks:[], activity:[] },
      { id:'t15', title:'Material handoff — Mesa job', type:'admin', company:'roofing', creator:'alkeith', assignee:'kristine', watchers:['abraham'], due:iso(2), priority:'low', urgency:'chill', status:'todo', description:'Voice note from Alkeith: confirm metal flashing arrives at yard by Thursday.', subtasks:[], activity:[{who:'Alkeith',what:'created via voice note',when:'1h ago'}] },
    ];
  }
